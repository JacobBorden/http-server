...
TEST(HTTPServerTests, GetMimeType) {
    ...
    ASSERT_EQ(HTTP::GetMimeType("doc.txt"), "text/plain");
    ASSERT_EQ(HTTP::GetMimeType("image.jpg"), "image/jpeg");
    ASSERT_EQ(HTTP::GetMimeType("image.jpeg"), "image/jpeg");
    ASSERT_EQ(HTTP::GetMimeType("icon.png"), "image/png");
    ASSERT_EQ(HTTP::GetMimeType("animation.gif"), "image/gif");
    ...
    ASSERT_EQ(HTTP::GetMimeType(".hidden_file_no_ext"), "application/octet-stream");
    ASSERT_EQ(HTTP::GetMimeType("file_ending_with_dot."), "application/octet-stream");
}
