...
// Test case for MimeType Lookup
TEST(HTTPServerTests, MimeTypeLookup) {
    ...
    ASSERT_EQ(HTTP::GetMimeType("document.txt"), "text/plain");
    ...
    ASSERT_EQ(HTTP::GetMimeType("font.ttf"), "font/ttf");
    ASSERT_EQ(HTTP::GetMimeType("audio.mp3"), "audio/mpeg");
    ASSERT_EQ(HTTP::GetMimeType("audio.wav"), "audio/wav");
    ASSERT_EQ(HTTP::GetMimeType("unknown.ext"), "application/octet-stream");
    ASSERT_EQ(HTTP::GetMimeType("file_without_ext"), "application/octet-stream");
}
